...
console.log("En Büyük: " + Math.max(1,2,10,56,20));
console.log("En Küçük: " + Math.min(1,2,10,56,20));
...
var toplamBrutMaas = brutMaas + (mesaiSuresi*brutMesai); 
var toplamNetMaas = toplamBrutMaas - (toplamBrutMaas*0.25);

console.log("Brut Maas: " + toplamBrutMaas.toFixed(2) + "  Net Maas: " +toplamNetMaas.toFixed(2));
